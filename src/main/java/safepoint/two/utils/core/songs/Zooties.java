...
public class Zooties {

    public static final ISound sound;
    private static final String song = "puffinonzooties";
    private static final ResourceLocation loc = new ResourceLocation("assets/minecraft/sounds/puffinonzooties.ogg");
