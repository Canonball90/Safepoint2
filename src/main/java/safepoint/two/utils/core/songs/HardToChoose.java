...
public class HardToChoose {
    public static final ISound sound;
    private static final String song = "hardtochoose";
    private static final ResourceLocation loc = new ResourceLocation("assets/minecraft/sounds/hardtochoose.ogg");
