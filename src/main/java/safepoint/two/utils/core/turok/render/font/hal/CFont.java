package safepoint.two.utils.core.turok.render.font.hal;
...
public class CFont {
    ...
    protected DynamicTexture setupTexture(Font font, boolean antiAlias, boolean fractionalMetrics, CharData[] chars) {
        BufferedImage bufferedImage = generateFontImage(font, antiAlias, fractionalMetrics, chars);
        ...
        try {
            ...
            glTexImage2D(GL_TEXTURE_2D, 0, GL_ALPHA, bufferedImage.getWidth(), bufferedImage.getHeight(), 0, GL12.GL_BGRA, GL12.GL_UNSIGNED_INT_8_8_8_8_REV, (IntBuffer) null);
