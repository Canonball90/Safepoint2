...
public class ModuleWindow {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        Safepoint.fontInitializer.drawString(name, isInside(mouseX, mouseY) ? x + 3 : x + 2, (int) (y + (height / 2f) - (Safepoint.mc.fontRenderer.FONT_HEIGHT / 2f)+1), -1, ClickGui.getInstance().shadow.getValue(), ClickGui.getInstance().customFont.getValue());
        if (module.isOpened) {
            int y = this.y;
